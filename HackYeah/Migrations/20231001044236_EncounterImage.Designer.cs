...
namespace HackYeah.Migrations
{
    ...
    [Migration("20231001044236_EncounterImage")]
    partial class EncounterImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HackYeah.DAL.Models.EncounterImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_encounter_images");

                    b.HasIndex("EncounterId")
                        .HasDatabaseName("ix_encounter_images_encounter_id");

                    b.ToTable("encounter_images", (string)null);
                });
            ...
            modelBuilder.Entity("HackYeah.DAL.Models.EncounterImage", b =>
                {
                    b.HasOne("HackYeah.DAL.Models.Encounter", "Encounter")
                        .WithMany()
                        .HasForeignKey("EncounterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_encounter_images_encounters_encounter_id");
